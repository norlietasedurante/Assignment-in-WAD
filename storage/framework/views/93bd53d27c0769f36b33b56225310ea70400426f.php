...
<div class="body">	
				<h1>Edit Stdent</h1>
								...
								<input type="text" name="firstName"  value="<?php echo e($firstname); ?>"> <br>

								<br><label> Middle:</label> 
								<input type="text" name="middleName" value="<?php echo e($middle); ?>"> <br>

								<br><label> LastName: </label>
								<input type="text" name="lastName" value="<?php echo e($lastname); ?>"> <br>

								<br><label> Course: </label>
								<input type="text" name="course_stud" value="<?php echo e($course); ?>"> <br>

								<br><label> idNumber: </label> 
								<input type="number" name="idNumber" value="<?php echo e($id_number); ?>"> <br><br>
